		...
		return (
			<div>
				...
				<ControlsContainer>
							...
							{showModelSelector && (
								<ModelSelectorTooltip
									...
									<ApiOptions
										...
										isPopup={true}
									/>
									<VSCodeButton onClick={handleModelButtonClick}
										style={{
											position: "absolute",
											right: "17px",
											bottom: "12px",
					...
					<Tooltip
						tipText={`在${chatSettings.mode === "act" ? "执行" : "计划"}模式下, ClineCN 将${chatSettings.mode === "act" ? "立即执行任务" : "收集信息形成计划"}`}
						hintText={`用 ${metaKeyChar}+Shift+A 按键切换`}>
