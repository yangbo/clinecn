...
// Cline 不更新 VSCode 类型定义或引擎要求以保持兼容性。
// 此声明（如 src/integrations/TerminalManager.ts 中所示）提供了较新版本 VSCode 中语言模型 API 的类型。
// 提取自 https://github.com/microsoft/vscode/blob/131ee0ef660d600cd0a7e6058375b281553abe20/src/vscode-dts/vscode.d.ts
...
/**
 * 处理 VS Code 语言模型 API 的聊天操作。
 * 此处理程序实现了 ApiHandler 接口以提供 VS Code LM 特定功能。
 *
 * @implements {ApiHandler}
 *
 * @remarks
 * 处理程序管理 VS Code 语言模型聊天客户端并提供以下方法：
 * - 创建和管理聊天客户端实例
